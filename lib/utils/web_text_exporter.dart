import 'package:thot/utils/web_text_exporter_stub.dart'
    if (dart.library.html) 'package:thot/utils/web_text_exporter_web.dart';
...
abstract interface class WebTextExporter {
  ...
  }) => WebTextExporterImpl.downloadTextFile(
    filename: filename,
    content: content,
  );
}
