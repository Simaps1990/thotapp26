...
class _CognitiveDrillsScreenState extends State<CognitiveDrillsScreen> {
    ...
    switch (mode) {
      case _CognitiveDrillMode.direction:
        return _parseFirstNumber(
          stats[strings.cognitiveDrillResultsTotalDuration] ?? '',
        );
      case _CognitiveDrillMode.stroop:
        final avgReaction = _parseFirstNumber(
          stats[strings.reflexesAvgReactionTime] ?? '',
        );
        if (avgReaction.isFinite) return avgReaction;
        final conflict = _parseFirstNumber(
          stats[strings.cognitiveDrillStroopAvgConflict] ?? '',
        );
        if (conflict.isFinite) return conflict;
        return _parseFirstNumber(
          stats[strings.cognitiveDrillStroopAvgCongruent] ?? '',
        );
    }
  }
  ...
  Future<void> _start() async {
    ...
    final cleanResult = Map<String, String>.from(result)
      ..remove('_close_tools');
        ...
        content: Column(
          ...
          children: [
            ListTile(
              ...
              subtitle: Text(
                strings.cognitiveDrillDirectionSubmode4ArrowsDesc,
              ...
              onTap: () {
                setState(
                  () => _directionSubMode = _DirectionSubMode.fourArrows,
                );
                Navigator.pop(context);
              },
            ),
            ListTile(
              ...
              subtitle: Text(
                strings.cognitiveDrillDirectionSubmodeLeftRightDesc,
                style: textStyles.bodySmall?.copyWith(color: colors.secondary),
              ),
            ...
            ListTile(
              leading: Icon(Icons.swap_horiz_rounded, color: colors.primary),
              title: Text(
                strings.cognitiveDrillDirectionSubmodeLeftCenterRight,
              ),
              subtitle: Text(
                strings.cognitiveDrillDirectionSubmodeLeftCenterRightDesc,
                style: textStyles.bodySmall?.copyWith(color: colors.secondary),
              ),
              ...
              onTap: () {
                setState(
                  () => _directionSubMode = _DirectionSubMode.leftCenterRight,
                );
                Navigator.pop(context);
              },
            ),
            ListTile(
              ...
              subtitle: Text(
                strings.cognitiveDrillDirectionSubmodeUpDownDesc,
                style: textStyles.bodySmall?.copyWith(color: colors.secondary),
              ),
            ...
            ListTile(
              ...
              subtitle: Text(
                strings.cognitiveDrillDirectionSubmodeUpDownCenterDesc,
                style: textStyles.bodySmall?.copyWith(color: colors.secondary),
              ),
              ...
              onTap: () {
                setState(
                  () => _directionSubMode = _DirectionSubMode.upDownCenter,
                );
                Navigator.pop(context);
              },
            ),
  ...
  void _showDirectionDifficultyDialog(
    BuildContext context,
    AppStrings strings,
  ) {
    final colors = Theme.of(context).colorScheme;
        ...
        content: Column(
          ...
          children: [
            ListTile(
              ...
              subtitle: Text(
                strings.cognitiveDrillDirectionEasyCriteria,
                style: textStyles.bodySmall?.copyWith(color: colors.secondary),
              ),
            ...
            ListTile(
              ...
              subtitle: Text(
                strings.cognitiveDrillDirectionMediumCriteria,
                style: textStyles.bodySmall?.copyWith(color: colors.secondary),
              ),
            ...
            ListTile(
              ...
              subtitle: Text(
                strings.cognitiveDrillDirectionHardCriteria,
                style: textStyles.bodySmall?.copyWith(color: colors.secondary),
              ),
                  ...
                  child: Column(
                    ...
                    children: [
                      _DrillCard(
                        ...
                        description:
                            strings.cognitiveDrillModeStroopCardDescription,
                        icon: Icons.psychology,
                        onTap: () =>
                            setState(() => _mode = _CognitiveDrillMode.stroop),
                        ...
                        _SettingsGroup(
                          ...
                          children: [
                            _SettingsItem(
                              ...
                              subtitle:
                                  _stroopDifficulty == _StroopDifficulty.easy
                                  ? strings.cognitiveDrillDifficultyEasy
                                  : _stroopDifficulty ==
              ...
              ? DecorationImage(
                  ...
                  colorFilter: ColorFilter.mode(
                    Colors.black.withValues(
                      alpha: widget.isSelected ? 0.3 : 0.6,
                    ),
                    BlendMode.darken,
                  ),
                )
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: widget.isSelected
                          ? LightColors.primary.withValues(alpha: 0.3)
...
class _DirectionRunScreenState extends State<_DirectionRunScreen>
  ...
  List<Map<String, String>> _top3(AppStrings strings) {
    ...
    if (current != null) {
      items.add({
        ...
        'date': DateTime.now().toString().substring(0, 16),
        '_primary': (_parseFirstNumber(
          current[strings.cognitiveDrillResultsTotalDuration] ?? '',
        )).toStringAsFixed(3),
        ...current,
      });
    }
  ...
  int _getCount() => widget.difficulty == _StroopDifficulty.easy
      ...
      ? 15
      : 20;
  int _getMs() => widget.difficulty == _StroopDifficulty.easy
      ? 1500
      : widget.difficulty == _StroopDifficulty.medium
      ? 1200
      : 900;
  ...
  Future<void> _run() async {
    ...
    for (var i = 0; i < _getCount(); i++) {
      ...
      if (stim is IconData) {
        if (stim == Icons.arrow_upward_rounded)
          _arrowCounts['up'] = _arrowCounts['up']! + 1;
        if (stim == Icons.arrow_downward_rounded)
          _arrowCounts['down'] = _arrowCounts['down']! + 1;
        if (stim == Icons.arrow_back_rounded)
          _arrowCounts['left'] = _arrowCounts['left']! + 1;
        if (stim == Icons.arrow_forward_rounded)
          _arrowCounts['right'] = _arrowCounts['right']! + 1;
      }
    ...
    final stats = <String, String>{
      ...
      strings.cognitiveDrillResultsStimulusDuration: _fmt(
        Duration(milliseconds: ms),
      ),
      strings.cognitiveDrillResultsTotalDuration: _fmt(
        _sw?.elapsed ?? Duration.zero,
      ),
    ...
    if (_arrowCounts.values.any((v) => v > 0)) {
      ...
      final stats = <String, String>{
        strings.cognitiveDrillResultsStimuliCount:
            '${_arrowCounts.values.reduce((a, b) => a + b)}',
        strings.cognitiveDrillResultsTotalDuration: _fmt(
          _sw?.elapsed ?? Duration.zero,
        ),
        strings.directionArrowsUp: '${_arrowCounts['up']}',
  ...
  dynamic _pick() {
    switch (widget.subMode) {
      ...
      case _DirectionSubMode.leftRight:
        return [Icons.arrow_back_rounded, Icons.arrow_forward_rounded][_random
            .nextInt(2)];
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  strings
                                      .cognitiveDrillDirectionArrowsBreakdown,
                                  style: texts.labelLarge?.copyWith(
                                    fontWeight: FontWeight.w800,
                                    color: colors.secondary,
                                  ),
                                ...
                                ...[
                                  (
                                    'up',
                                    Icons.arrow_upward_rounded,
                                    strings.directionArrowsUp,
                                  ),
                                  (
                                    'down',
                                    Icons.arrow_downward_rounded,
                                    strings.directionArrowsDown,
                                  ),
                                  (
                                    'left',
                                    Icons.arrow_back_rounded,
                                    strings.directionArrowsLeft,
                                  ),
                                  (
                                    'right',
                                    Icons.arrow_forward_rounded,
                                    strings.directionArrowsRight,
                                  ),
                                ].where((e) => (_arrowCounts[e.$1] ?? 0) > 0).map((
                                  e,
                                ) {
                                  final count = _arrowCounts[e.$1] ?? 0;
                                  final total = _arrowCounts.values.fold<int>(
                                    0,
                                    (a, b) => a + b,
                                  );
      ...
      body: Stack(
        children: [
          _LandscapeWrapper(
            color: Colors.black,
            child: _running
                ? _DirectionStimulusView(stimulus: _stimulus)
                : _ExerciseCountdown(
                    value: _countdown,
                    title: strings.cognitiveDrillModeDirection,
                  ),
          ),
          Positioned(
            top: 20,
...
class _StroopRunScreenState extends State<_StroopRunScreen>
  ...
  List<Map<String, String>> _top3(AppStrings strings) {
    ...
    final current = _currentResult;
    if (current != null) {
      final primary = _parseFirstNumber(
        current[strings.reflexesAvgReactionTime] ?? '',
      );
...
class _DirectionStimulusViewState extends State<_DirectionStimulusView>
    with SingleTickerProviderStateMixin {
