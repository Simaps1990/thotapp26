...
String get weatherUsageExplanation => _pick(
  ...
  String get freeVersionPlatformLimit => _pick(
        fr:
            'Version gratuite : seule la première plateforme est utilisable. Passez à Pro pour débloquer tout le matériel.',
        en:
            'Free version: only the first platform is usable. Upgrade to Pro to unlock all equipment.',
        de:
            'Kostenlose Version: nur die erste Plattform ist verwendbar. Upgrade auf Pro, um die gesamte Ausrüstung freizuschalten.',
        it:
            'Versione gratuita: solo la prima piattaforma è utilizzabile. Passa a Pro per sbloccare tutta l\'attrezzatura.',
        es:
            'Versión gratuita: solo la primera plataforma es utilizable. Actualiza a Pro para desbloquear todo el equipo.',
      );

  String get freeVersionAmmoLimit => _pick(
        fr:
            'Version gratuite : seule le premier consommable est utilisable. Passez à Pro pour débloquer tout le matériel.',
        en:
            'Free version: only the first 5 consumable entries are usable. Upgrade to Pro to unlock all equipment.',
        de:
            'Kostenlose Version: nur die ersten 5 Verbrauchsmaterial sind verwendbar. Upgrade auf Pro, um die gesamte Ausrüstung freizuschalten.',
        it:
            'Versione gratuita: solo i primi 5 consumabili sono utilizzabili. Passa a Pro per sbloccare tutta l\'attrezzatura.',
        es:
            'Versión gratuita: solo los primeros 5 consumibles son utilizables. Actualiza a Pro para desbloquear todo el equipo.',
      );
...
es: 'Modifique una plantilla de ejercicio existente.',
  ...
  String get exerciseTemplatesStandardBadge => _pick(
        fr: 'STD',
        en: 'STD',
        de: 'STD',
        it: 'STD',
