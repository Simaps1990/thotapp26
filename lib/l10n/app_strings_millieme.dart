...
extension AppStringsMillieme on AppStrings {
  ...
  String get milliemePresetPylonHeight =>
      _pick(fr: 'Pylône', en: 'Pylon', de: 'Mast', it: 'Palo', es: 'Pilona');

  String get milliemePresetPylonWidth =>
      _pick(fr: 'Pylône', en: 'Pylon', de: 'Mast', it: 'Palo', es: 'Pilona');

  String get milliemePresetTruckHeight =>
      _pick(fr: 'Camion', en: 'Truck', de: 'Lkw', it: 'Camion', es: 'Camión');

  String get milliemePresetTruckWidth =>
      _pick(fr: 'Camion', en: 'Truck', de: 'Lkw', it: 'Camion', es: 'Camión');

  String get milliemePresetCarHeight =>
      _pick(fr: 'Voiture', en: 'Car', de: 'Auto', it: 'Auto', es: 'Coche');

  String get milliemePresetCarWidth =>
      _pick(fr: 'Voiture', en: 'Car', de: 'Auto', it: 'Auto', es: 'Coche');

  String get milliemePresetHumanHeight =>
      _pick(fr: 'Humain', en: 'Human', de: 'Mensch', it: 'Umano', es: 'Humano');

  String get milliemePresetHeadHeight =>
      _pick(fr: 'Tête', en: 'Head', de: 'Kopf', it: 'Testa', es: 'Cabeza');

  String get milliemePresetHeadWidth =>
      _pick(fr: 'Tête', en: 'Head', de: 'Kopf', it: 'Testa', es: 'Cabeza');

  String get milliemePresetDoorHeight =>
      _pick(fr: 'Porte', en: 'Door', de: 'Tür', it: 'Porta', es: 'Puerta');

  String get milliemePresetDoorWidth =>
      _pick(fr: 'Porte', en: 'Door', de: 'Tür', it: 'Porta', es: 'Puerta');
  ...
  String get milliemePresetTreeHeight =>
      _pick(fr: 'Arbre', en: 'Tree', de: 'Baum', it: 'Albero', es: 'Árbol');

  String get milliemePresetTreeWidth =>
      _pick(fr: 'Arbre', en: 'Tree', de: 'Baum', it: 'Albero', es: 'Árbol');

  String get milliemePresetHouseHeight =>
      _pick(fr: 'Maison', en: 'House', de: 'Haus', it: 'Casa', es: 'Casa');

  String get milliemePresetHouseWidth =>
      _pick(fr: 'Maison', en: 'House', de: 'Haus', it: 'Casa', es: 'Casa');
