...
extension AppStringsExerciseSteps on AppStrings {
  ...
  String get exerciseStepsTitle =>
      _pick(fr: 'Étapes', en: 'Steps', de: 'Schritte', it: 'Fasi', es: 'Pasos');
  ...
  String get exerciseAutoBadge =>
      _pick(fr: 'TOTAL', en: 'TOTAL', de: 'TOTAL', it: 'TOTAL', es: 'TOTAL');

  String exerciseAutoTotals(
    int totalShots,
    int stepCount,
    int maxDistance,
    String distanceUnit,
  ...
  String get exerciseStepTypeTitle =>
  ...
  String get exerciseFieldReloadType =>
      _pick(fr: 'Type', en: 'Type', de: 'Typ', it: 'Tipo', es: 'Tipo');
  ...
  String get exerciseNarrativeThen =>
      _pick(fr: '', en: '', de: '', it: '', es: '');

  String get exerciseNarrativeFinally =>
      _pick(fr: '', en: '', de: '', it: '', es: '');
  ...
  // Pour la transition
  String get exerciseNarrativeFrom =>
      _pick(fr: ' de ', en: ' from ', de: ' von ', it: ' da ', es: ' de ');

  String get exerciseNarrativeTo =>
      _pick(fr: ' vers ', en: ' to ', de: ' zu ', it: ' a ', es: ' a ');
  ...
  /// e.g. " à " / " at "
  String get exerciseNarrativeAtDistance =>
      _pick(fr: ' à ', en: ' at ', de: ' auf ', it: ' a ', es: ' a ');
