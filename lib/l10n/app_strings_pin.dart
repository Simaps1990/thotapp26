...
es: 'Historial de disparos',
  ...
  String itemPageTitle(String category, bool isEdit) {
    switch (category) {
      case 'PLATEFORME':
        return isEdit
            ? _pick(fr: 'ÉDITER PLATEFORME', en: 'EDIT PLATFORM', de: 'PLATTFORM BEARBEITEN', it: 'MODIFICA CONFIGURAZIONE', es: 'EDITAR CONFIGURACIÓN')
            : _pick(fr: 'NOUVELLE PLATEFORME', en: 'NEW PLATFORM', de: 'NEUE PLATTFORM', it: 'NUOVA CONFIGURAZIONE', es: 'NUEVA CONFIGURACIÓN');
      case 'CONSOMMABLE':
        return isEdit
            ? _pick(fr: 'ÉDITER CONSOMMABLE', en: 'EDIT AMMO', de: 'VERBRAUCHSMATERIAL BEARBEITEN', it: 'MODIFICA CONSUMABILE', es: 'EDITAR CONSUMIBLE')
            : _pick(fr: 'NOUVEAU CONSOMMABLE', en: 'NEW AMMO', de: 'NEUES VERBRAUCHSMATERIAL', it: 'NUOVO CONSUMABILE', es: 'NUEVO CONSUMIBLE');
      case 'ACCESSOIRE':
        return isEdit
  ...
  String itemAccessoryTypeLabel(String value) {
    switch (value) {
      ...
      case 'Supports de tir':
        return _pick(fr: "Supports d'appui", en: 'Support rests', de: 'Auflagen', it: "Supporti d'appoggio", es: 'Apoyos de soporte');
      case 'Outils':
  ...
  String itemPlatformTypeLabel(String value) {
    switch (value) {
      case 'PA':
        return _pick(fr: 'PA', en: 'Pistol', de: 'Pistole', it: 'Pistola', es: 'Pistola');
      case 'Révolver':
      ...
      case 'FAP':
        return _pick(fr: 'FAP', en: 'Pump-action', de: 'Pump', it: 'Pompa', es: 'Corredera');
      case 'Fusil de chasse':
        return _pick(fr: 'Fusil de chasse', en: 'Shotgun', de: 'Flinte', it: 'Fucile caccia', es: 'Escopeta');
      case 'FP':
...
es: 'HISTORIAL',
  ...
  String get dopeFilterAll => _pick(
        fr: 'Toutes',
        en: 'All',
        de: 'Alle',
        it: 'Tutte',
  ...
  String get allFilterLabel => _pick(
        fr: 'Tous',
        en: 'All',
        de: 'Alle',
        it: 'Tutti',
  ...
  String get updateAvailableTitle => _pick(fr: 'Mise à jour disponible', en: 'Update available', de: 'Update verfügbar', it: 'Aggiornamento disponibile', es: 'Actualización disponible');
  ...
  String get updateAvailableOpenStore => _pick(fr: 'Ouvrir le store', en: 'Open store', de: 'Store öffnen', it: 'Apri store', es: 'Abrir tienda');
  String get remindLater => _pick(fr: 'Plus tard', en: 'Later', de: 'Später', it: 'Più tardi', es: 'Más tarde');
