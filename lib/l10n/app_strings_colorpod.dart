...
extension AppStringsColorPod on AppStrings {
  String get colorPodToolTitle => _pick(fr: 'STIMULIS VISUELS', en: 'VISUAL STIMULI', de: 'VISUELLE STIMULI', it: 'STIMOLI VISIVI', es: 'ESTÍMULOS VISUALES');
...
Ejemplos de uso: un color para una acción, una dirección entre objetivos alineados, formas en un objetivo, letras/números correspondientes a acciones.''',
  ...
  String get colorPodNext => _pick(fr: 'SUIVANT', en: 'NEXT', de: 'WEITER', it: 'SUCCESSIVO', es: 'SIGUIENTE');
  ...
  String get colorPodDirections => _pick(fr: 'DIRECTION', en: 'DIRECTION', de: 'RICHTUNG', it: 'DIREZIONE', es: 'DIRECCIÓN');
  String get colorPodDirectionLeft => _pick(fr: 'Gauche', en: 'Left', de: 'Links', it: 'Sinistra', es: 'Izquierda');
  String get colorPodDirectionRight => _pick(fr: 'Droite', en: 'Right', de: 'Rechts', it: 'Destra', es: 'Derecha');
  String get colorPodDirectionUp => _pick(fr: 'Haut', en: 'Up', de: 'Oben', it: 'Su', es: 'Arriba');
  String get colorPodDirectionDown => _pick(fr: 'Bas', en: 'Down', de: 'Unten', it: 'Giù', es: 'Abajo');
  String get colorPodDirectionCenter => _pick(fr: 'Centre', en: 'Center', de: 'Mitte', it: 'Centro', es: 'Centro');
