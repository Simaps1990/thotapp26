...
es: 'Impactos múltiples',
  ...
  String get hitFactorMajor => _pick(
        fr: 'Major',
        en: 'Major',
        de: 'Major',
        it: 'Major',
  ...
  String get hitFactorMinor => _pick(
        fr: 'Minor',
        en: 'Minor',
        de: 'Minor',
        it: 'Minor',
...
es: 'Ejercicios cognitivos para entrenar reflejos, atención, memoria y decisión.',
  ...
  String get cognitiveDrillDifficultyEasy => _pick(
        fr: 'Facile',
        en: 'Easy',
        de: 'Leicht',
        it: 'Facile',
  ...
  String get cognitiveDrillDifficultyMedium => _pick(
        fr: 'Moyen',
        en: 'Medium',
        de: 'Mittel',
        it: 'Medio',
...
es: 'Test M.O.T',
  ...
  String get reflexesModeMotHeader => _pick(
        fr: 'M.O.T',
        en: 'M.O.T',
        de: 'M.O.T',
        it: 'M.O.T',
